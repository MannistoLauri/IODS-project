...
```
Now there are no mor outliers. After removing the outliers it would be time to perform a t-test. How ever t-test would require 2 gopups and we have 3. That is an issue! To solve this we will abondon the t-test and move to anova.
